...
import { Bell, ChevronDown, Code2, Heart, Menu, MessageCircle, Pencil, Plus, Search, Send, Shield, Trash2, X } from "lucide-react";
...
export default function Home() {
  ...
  useEffect(() => { void loadPosts(); setOwnedPosts(readOwnedPosts()); setOwnedComments(readOwnedComments()); }, []);
  useEffect(() => {
    if (!supabase) return;
